...
as.alienData <- function(idObs = NULL, interactPair = NULL, coOcc = NULL, coAbund = NULL,
    ...
    res <- list(idObs = idObs, interactPair = interactPair, interactSp = interactSp, interactInd = interactInd, 
        coOcc = coOcc, coAbund = coAbund, siteEnv = siteEnv, traitSp = traitSp, traitInd = traitInd,
        phylo = phylo)
