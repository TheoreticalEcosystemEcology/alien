...
#'
#' @param an object of the class alienData, see as.alienData function.
#' @param method to be applied on the data which can be 'rf' for randomForest or 'glm'.
#' @param glm family, one family of the `stats` package (e.g. binomial(), Gamma(), gaussian() etc.)
...
#' @param vector of traits to include in the algorithm
#' @param logical, specify if variables are selected by stepAIC. Only for glm
#' @param ... other params passed to the glm, stepAIC or randomForest algorithm
...
#'
#' @export
fitDirectCentrality <- function(data, class = NULL, family = NULL, level = "species", 
    formula = "I ~ . * .", traits = NULL, step = FALSE, ...) {
