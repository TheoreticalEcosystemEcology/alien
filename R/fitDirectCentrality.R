...
#' @param step specify if variables are selected by stepAIC. Only availabe for glm class.
#' @param ... other params passed to the glm, step or randomForest functions.
#' @examples fitDirectCentrality(bartomeus,class='glm',family=gaussian(),level='species')
#' @author
...
#'
#' @export
fitDirectCentrality <- function(data, class = NULL, family = NULL, formula = "I ~ . * .", level = "species",  traits = NULL, step = FALSE, ...) {
