...
#'
getNull <- function(A) {
    .Call('alien_getNull', PACKAGE = 'alien', A)
}
...
getNullOne <- function(nbsp) {
    .Call('alien_getNullOne', PACKAGE = 'alien', nbsp)
}
...
webFromNicheModel <- function(nbsp, connec, connect_all = FALSE, unbias = FALSE, niche = NULL) {
    .Call('alien_webFromNicheModel', PACKAGE = 'alien', nbsp, connec, connect_all, unbias, niche)
}
