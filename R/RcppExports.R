...
traitsBasedJointCooc <- function(env, metaweb, alpha, trait1, trait2 = NULL, trait3 = NULL) {
    .Call("alienR_traitsBasedJointCooc", PACKAGE = "alienR", env, metaweb, alpha, 
...
#' @export
#'
webFromNicheModel <- function(nbsp, connec, connect_all = FALSE, unbias = FALSE, 
    niche = NULL) {
...
#'
#' @export
webFromTraitMatching <- function(nbsp, trait1 = NULL, trait2 = NULL, trait3 = NULL, 
    trait4 = NULL) {
    .Call("alienR_webFromTraitMatching", PACKAGE = "alienR", nbsp, trait1, trait2, 
        trait3, trait4)
}
