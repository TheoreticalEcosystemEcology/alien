...
#### To remove after everything works
#### To remove after everything works
#### To remove after everything works
```{r, echo=FALSE, eval=TRUE}
salixGal <- readRDS("~/Desktop/test/Kate/code/adat_sg.RDS")
galPara <- readRDS("~/Desktop/test/Kate/code/adat_gp.RDS")
```
...
cor(as.vector(salixGalKNNInter), as.vector(salixGalKNNInterTrait))
cor(as.vector(salixGalKNNInterTrait), as.vector(salixGalKNNInterPhylo))
cor(as.vector(salixGalKNNInter), as.vector(salixGalKNNInterPhylo))

cor(as.vector(galParaKNNInter), as.vector(galParaKNNInterPhylo))
cor(as.vector(galParaKNNInter), as.vector(galParaKNNInterTrait))
cor(as.vector(galParaKNNInterTrait), as.vector(galParaKNNInterPhylo))
